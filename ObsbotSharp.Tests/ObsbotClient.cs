...
using ObsbotSharp.Tests.Models.TailSeries;
...
public class ObsbotClient : IDisposable
{
    ...
    public class GeneralCommands
    {
        ...
        public GeneralCommands(ObsbotClient obsbotClient) => this.obsbotClient = obsbotClient;
    ...
    public class TinySeries : GeneralCommands
    {
        private ObsbotClient obsbotClient;
        public TinySeries (ObsbotClient obsbotClient) : base(obsbotClient) => this.obsbotClient = obsbotClient;
    ...
    public class TailSeries : GeneralCommands
    {
        private ObsbotClient obsbotClient;
    ...
    public class MeetSeries : GeneralCommands
    {
        private ObsbotClient obsbotClient;
